...
class PicnicPhoto extends StatefulWidget {
  @override
  _PicnicPhotoState createState() => _PicnicPhotoState();
}

class _PicnicPhotoState extends State<PicnicPhoto> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Picnic Pictures", style: TextStyle(color: Colors.white),),backgroundColor: Colors.green,),
      body: StreamBuilder(
        stream: slides,
        initialData: [],
  ...
  Stream _queryDb({String tag='favorites'}){
    //Make a query
    Query query = db.collection('picnic_images');
