...
class DinnerPhoto extends StatefulWidget{
  @override
  _DinnerPhotoState createState() => _DinnerPhotoState();
}

class _DinnerPhotoState extends State<DinnerPhoto> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("Dinner Pictures" ,style: TextStyle(color: Colors.white),),backgroundColor: Colors.green,),
      body: StreamBuilder(
        stream: slides,
        initialData: [],
  ...
  Stream _queryDb({String tag='favorites'}){
    //Make a query
    Query query = db.collection('dinner_images');
